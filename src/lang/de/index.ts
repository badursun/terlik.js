...
/**
 * German-only Terlik instance. Only the DE dictionary is bundled.
 *
 * @example
 * ```ts
 * import { Terlik } from "terlik.js/de";
 * const t = new Terlik();
 * t.containsProfanity("scheiße"); // true
 * ```
 */
...
/** Pre-resolved German language config for advanced usage with TerlikCore. */
export { config as languageConfig };

/** Convenience factory — returns a pre-configured German Terlik instance. */
